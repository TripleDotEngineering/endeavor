...
\documentclass[${{ env.get('mode', 'acmendeavor,nonacm') }}]{acmart}
...
\setcopyright{none}
\copyrightyear{${{ env.get('year', '') }}}
\acmYear{${{ env.get('year', '') }}}
...
\renewcommand{\shortauthors}{${{ env.get('left_header', '')}}}

%%
%% The abstract is a short summary of the work to be presented in the
%% article.
<?ev if env.get('abstract', False) ?>
\begin{abstract}
  \textbf{Abstract:} \\
  ${{ env['abstract'] }}
\end{abstract}
